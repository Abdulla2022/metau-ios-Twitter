...
1. handling the all strings and urls in one class where each string and url will be stored in variables 
2. using MVC pattern 
...
<img src='https://media.giphy.com/media/0hq2XbsHppoWdwYFDi/giphy.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
